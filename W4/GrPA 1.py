...
singleton_list = [some_value] # list: A list with only one element
singleton_set = {some_value} # set: A set with only one element
singleton_tuple = (some_value,) # tuple: A tuple with only one element
...
if isinstance(int_iterable, (list, tuple)) : # some iterables are not reversible why?
...
if isinstance(some_collection, (list, tuple, str)): # some collections are not ordered
